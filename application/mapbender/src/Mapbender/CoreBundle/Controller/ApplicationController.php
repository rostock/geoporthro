...
//            $this->get("request")->request->all() : $this->get("request")->query->all();
    ...
    public function dataUrlAction($slug)
    {
        ...
        $connection_host = $this->container->getParameter('metadata_host');
        $connection_dbname = $this->container->getParameter('metadata_dbname');
        $connection_user = $this->container->getParameter('metadata_user');
        $connection_password = $this->container->getParameter('metadata_password');
