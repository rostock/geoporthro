...
namespace Mapbender\HroBundle\Template;
 ...
 * Template Desktop
 */
class Desktop extends Template
{
    ...
    {
        $assets = array(
            'css'   => array('@MapbenderCoreBundle/Resources/public/sass/template/fullscreen.scss','@MapbenderHroBundle/Resources/public/desktop.css'),
            'js'    => array(
    ...
    public function render($format = 'html', $html = true, $css = true, $js = true)
    {
        ...
        return $templating
                ->render('MapbenderHroBundle:Template:desktop.html.twig', array(
                    'html' => $html,
                    'css' => $css,
                    'js' => $js,
