...
//                '@MapbenderCoreBundle/Resources/public/sass/theme/mapbender3.scss'
    ...
    public function getLateAssets($type)
    {
        $assets = array(
            'css' => array(
                '@MapbenderMobileBundle/Resources/public/sass/theme/mobile.scss','@MapbenderHroBundle/Resources/public/mobile.css'
            ),
            'js' => array(),
            'trans' => array()
        );
    ...
    public function render($format = 'html', $html = true, $css = true, $js = true)
    {
        ...
        return $templating->render(
            'MapbenderHroBundle:Template:mobile.html.twig',
            array(
                'html' => $html,
                'css' => $css,
                'js' => $js,
