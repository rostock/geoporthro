(function ($) {
    $.widget("mapbender.mbThematicSearchOne", {
        ...
        hilfetexte: {
            ...
            gruenpflegeobjekte: '<li>→ Art [Beispiel: <span>ballspielan</span>]</li><li>→ Nummer [Beispiele: <span>3015/02</span> oder <span>3015</span>]</li><li>→ Bezeichnung [Beispiel: <span>langenorter hufe/haferweg</span>]</li><li>→ Grünpflegebezirk [Beispiel: <span>25</span>]</li></ul><br/>Resultate können Friedhöfe, Parks und Grünanlagen, Spielplätze sowie Straßenbegleitgrün sein.',
