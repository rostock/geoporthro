(function ($) {
    $.widget("mapbender.mbThematicSearchOne", {
        ...
        hilfetexte: {
            ...
            anundverkauf: '<li>→ Aktenzeichen [Beispiel: <span>2332VW140003</span>]</li></ul><br/>Es werden je Aktenzeichen immer sowohl die Teilflächen als auch die Gesamtfläche gelistet.',
            anlagevermoegendereigenbetriebe: '<li>→ Flurstück in verschiedenen Kombinationen (Reihenfolge egal) [Beispiele: <span>2245 884</span> oder <span>2245 1 884</span> oder <span>2245 1 /98</span> oder <span>2245 /98</span> oder <span>flurbezirk vi 884</span> oder <span>flurbezirk vi 1 884</span> oder <span>flurbezirk vi 1 /98</span> oder <span>flurbezirk vi /98</span>]</li><li>→ Aktenzeichen [Beispiele: <span>00.06.-22441-bG-0043</span> oder <span>00.06.-22451</span> oder <span>223814</span>]</li><li>→ Kürzel [Beispiel: <span>BV 88</span>]</li><li>→ Wirtschaftseinheit [Beispiel: <span>1177</span>]</li></ul>',
            ...
            bebauungsplaene: '<li>→ Nummer [Beispiele: <span>16.w.43</span> oder <span>16w</span>]</li><li>→ Bezeichnung [Beispiel: <span>nienhag</span>]</li></ul>',
            betriebegewerblicherart: '<li>→ Flurstück in verschiedenen Kombinationen (Reihenfolge egal) [Beispiele: <span>2241 372</span> oder <span>2241 1 372</span> oder <span>2241 1 /3</span> oder <span>2241 /3</span> oder <span>flurbezirk ii 372</span> oder <span>flurbezirk ii 1 372</span> oder <span>flurbezirk ii 1 /3</span> oder <span>flurbezirk ii /3</span>]</li><li>→ Aktenzeichen [Beispiele: <span>00.06.-22201-bG-0011</span> oder <span>00.06.-22352</span> oder <span>223815</span>]</li><li>→ Kürzel [Beispiel: <span>B83-1</span>]</li><li>→ Bemerkungen [Beispiel: <span>Stadthafen</span>]</li></ul>',
            ...
            freizeitsport: '<li>→ Art [Beispiele: <span>Ballspielanlage</span> oder <span>Skateanlage</span>]</li><li>→ Bezeichnung [Beispiele: <span>Löwenzahnweg</span> oder <span>Gehlsheimer Str.</span>]</li></ul>',
            ...
            switch(search){
                ...
                case 'grundsteuerobjekte':
                    if (this.firstTimeSearch.grundsteuerobjekte === true) {
                        ...
                        $('input[name="selected"]', layertreeLayerContainer).each(function(idx, item) {
                            var layertreeLayerCheckbox = $(item);
                            layertreeLayerCheckbox.prop('checked', true);
                            layertreeLayerCheckbox.change();
                        });
                    }
