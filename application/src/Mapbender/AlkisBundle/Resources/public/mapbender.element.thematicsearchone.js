(function ($) {
    $.widget("mapbender.mbThematicSearchOne", {
        ...
        hilfetexte: {
            ...
            anundverkauf: '<li>→ Flurstück in verschiedenen Kombinationen (Reihenfolge egal) [Beispiele: <span>2231 179</span> oder <span>2231 1 179</span> oder <span>2231 1 /1</span> oder <span>2231 /1</span> oder <span>gehlsdorf 179</span> oder <span>gehlsdorf 1 179</span> oder <span>gehlsdorf 1 /1</span> oder <span>gehlsdorf /1</span>]</li><li>→ Aktenzeichen [Beispiele: <span>2332VW140003</span> oder <span>2332</span>]</li><li>→ Bemerkungen [Beispiel: <span>brückenweg</span>]</li><li>→ Realnutzungsart [Beispiel: <span>SO</span>]</li></ul>',
            anlagevermoegendereigenbetriebe: '<li>→ Flurstück in verschiedenen Kombinationen (Reihenfolge egal) [Beispiele: <span>2245 884</span> oder <span>2245 1 884</span> oder <span>2245 1 /98</span> oder <span>2245 /98</span> oder <span>flurbezirk vi 884</span> oder <span>flurbezirk vi 1 884</span> oder <span>flurbezirk vi 1 /98</span> oder <span>flurbezirk vi /98</span>]</li><li>→ Aktenzeichen [Beispiele: <span>00.06.-22441-bG-0043</span> oder <span>00.06.-22451</span> oder <span>223814</span>]</li><li>→ Realnutzungsart [Beispiel: <span>BV 88</span>]</li><li>→ Wirtschaftseinheit [Beispiel: <span>1177</span>]</li></ul>',
