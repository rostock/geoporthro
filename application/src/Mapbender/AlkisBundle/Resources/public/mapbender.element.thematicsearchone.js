(function ($) {
    $.widget("mapbender.mbThematicSearchOne", {
        ...
        hilfetexte: {
            ...
            anundverkauf: '<li>→ Flurstück in verschiedenen Kombinationen (Reihenfolge egal) [Beispiele: <span>2231 179</span> oder <span>2231 1 179</span> oder <span>2231 1 /1</span> oder <span>2231 /1</span> oder <span>gehlsdorf 179</span> oder <span>gehlsdorf 1 179</span> oder <span>gehlsdorf 1 /1</span> oder <span>gehlsdorf /1</span>]</li><li>→ Aktenzeichen An- und Verkauf [Beispiele: <span>2332VW140003</span> oder <span>2332</span>]</li><li>→ Realnutzungsart [Beispiel: <span>KGA</span>]</li><li>→ Bemerkung An- und Verkauf [Beispiel: <span>brückenweg</span>]</li></ul>',
            anlagevermoegendereigenbetriebe: '<li>→ Flurstück in verschiedenen Kombinationen (Reihenfolge egal) [Beispiele: <span>2245 884</span> oder <span>2245 1 884</span> oder <span>2245 1 /98</span> oder <span>2245 /98</span> oder <span>flurbezirk vi 884</span> oder <span>flurbezirk vi 1 884</span> oder <span>flurbezirk vi 1 /98</span> oder <span>flurbezirk vi /98</span>]</li><li>→ Aktenzeichen Vermögensbewertung [Beispiele: <span>00.06.-22441-bG-0043</span> oder <span>00.06.-22451</span> oder <span>223814</span>]</li><li>→ Realnutzungsart [Beispiel: <span>BV 88</span>]</li><li>→ Wirtschaftseinheit Betriebsvermögen [Beispiel: <span>1177</span>]</li></ul>',
            baumkataster: '<li>→ Bewirtschafter [Beispiel: <span>62</span>]</li><li>→ Bezirk [Beispiel: <span>19</span>]</li><li>→ Objektnummer [Beispiele: <span>3027/02</span> oder <span>3027</span>]</li><li>→ Objektbezeichnung [Beispiel: <span>barnstorfer anla</span>]</li><li>→ Nummer als Kombination aus Bezirk, Objektnummer und Nummer (Reihenfolge egal) [Beispiel: <span>11 3004 19</span>]</li><li>→ Nummer als Kombination aus Bezirk, Objektbezeichnung und Nummer (Reihenfolge egal) [Beispiel: <span>11 tolstoi 19</span>]</li><li>→ Teil als Kombination aus Bezirk, Objektnummer und Teil (Reihenfolge egal) [Beispiel: <span>19 1100/04 956</span>]</li><li>→ Teil als Kombination aus Bezirk, Objektbezeichnung und Teil (Reihenfolge egal) [Beispiel: <span>19 wallanl 956</span>]</li></ul><br/>Resultate können Bäume, Bäume (gefällt), Baumgruppen sowie Baumreihen sein.',
            ...
            betriebegewerblicherart: '<li>→ Flurstück in verschiedenen Kombinationen (Reihenfolge egal) [Beispiele: <span>2241 372</span> oder <span>2241 1 372</span> oder <span>2241 1 /3</span> oder <span>2241 /3</span> oder <span>flurbezirk ii 372</span> oder <span>flurbezirk ii 1 372</span> oder <span>flurbezirk ii 1 /3</span> oder <span>flurbezirk ii /3</span>]</li><li>→ Aktenzeichen Vermögensbewertung [Beispiele: <span>00.06.-22201-bG-0011</span> oder <span>00.06.-22352</span> oder <span>223815</span>]</li><li>→ Realnutzungsart [Beispiel: <span>BgA 5</span>]</li><li>→ Bemerkung Betriebe gewerblicher Art [Beispiel: <span>Stadthafen</span>]</li></ul>',
            grundvermoegen: '<li>→ Aktenzeichen Vermögensbewertung [Beispiele: <span>00.06.-22413-igb-0021</span> oder <span>00.06.-22352</span> oder <span>2235</span>]</li></ul>',
