(function ($) {
    $.widget("mapbender.mbOlcSearch", {
        ...
        _findOnKeyup: function (e) {
            ...
            if ($('#search-olc', self.element).val().length > 1) {
