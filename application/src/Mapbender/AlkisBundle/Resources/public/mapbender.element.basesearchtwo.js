(function ($) {
    $.widget("mapbender.mbBaseSearchTwo", {
        ...
        hilfetexte: {
            ...
            flur: '<li>→ Gemarkungsschlüssel [Beispiel: <span>2218</span>]</li><li>→ Gemarkungsname [Beispiel: <span>kasseb</span>]</li><li>→ Flur als Kombination aus Gemarkungsschlüssel und Flurnummer (Reihenfolge egal) [Beispiel: <span>2222 3</span>]</li><li>→ Flur als Kombination aus Gemarkungsname und Flurnummer (Reihenfolge egal) [Beispiel: <span>evershagen 3</span>]</li><li>→ Flurstück in verschiedenen Kombinationen (Reihenfolge egal) [Beispiele: <span>2232 461</span> oder <span>2232 1 461</span> oder <span>2232 1 /5</span> oder <span>2232 /5</span> oder <span>krummen 461</span> oder <span>krummen 1 461</span> oder <span>krummen 1 /5</span> oder <span>krummen /5</span>]</li></ul><br/>Resultate können Gemarkungen, Fluren und Flurstücke sein.'
        },
        line_style: {
            'strokeColor': '#cc00ff',
            'fillColor': '#cc00ff',
